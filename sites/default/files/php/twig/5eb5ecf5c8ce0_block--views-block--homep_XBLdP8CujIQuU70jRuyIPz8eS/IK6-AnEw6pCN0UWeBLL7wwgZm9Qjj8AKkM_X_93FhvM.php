...
/* themes/custom/ana_zymphonies/templates/block/block--views-block--homepage-block-4-3.html.twig */
class __TwigTemplate_1ba6d0f1e780d47a0fb495fa6f33eea1a238f1a331d7f1760634b74ff9b53d69 extends \Twig\Template
{
...
";
  ...
  ";
    ...
    {
        return "themes/custom/ana_zymphonies/templates/block/block--views-block--homepage-block-4-3.html.twig";
    }
...
%}
<div class=\"popular-news {{ attributes.class }}\"{{attributes|without('class') }}>
  {{ title_prefix }}
  {% if label %}
    <h2  class=\"popular-news {{ title_attributes.class }}\" {{title_attributes|without('class') }}>{{ label }}</h2>
  {% endif %}
  {{ title_suffix }}
  {% block content %}
    {{ content }}
...
", "themes/custom/ana_zymphonies/templates/block/block--views-block--homepage-block-4-3.html.twig", "C:\\xampp\\htdocs\\newslive\\themes\\custom\\ana_zymphonies\\templates\\block\\block--views-block--homepage-block-4-3.html.twig");
    }
}
