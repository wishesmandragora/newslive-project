...
/* themes/custom/ana_zymphonies/templates/block/block--views-block--homepage-block-2-3.html.twig */
class __TwigTemplate_6f12f4fa671f0b5f8f3fc779e7946adcea3fe021ab2cdf859f26209489e18e45 extends \Twig\Template
{
...
";
  ...
  ";
    ...
    {
        return "themes/custom/ana_zymphonies/templates/block/block--views-block--homepage-block-2-3.html.twig";
    }
...
%}
<div class=\"videos {{ attributes.class }}\"{{attributes|without('class') }}>
  {{ title_prefix }}
  {% if label %}
    <h2  class=\"videos {{ title_attributes.class }}\" {{title_attributes|without('class') }}>{{ label }}</h2>
  {% endif %}
  {{ title_suffix }}
  {% block content %}
    {{ content }}
...
", "themes/custom/ana_zymphonies/templates/block/block--views-block--homepage-block-2-3.html.twig", "C:\\xampp\\htdocs\\newslive\\themes\\custom\\ana_zymphonies\\templates\\block\\block--views-block--homepage-block-2-3.html.twig");
    }
}
