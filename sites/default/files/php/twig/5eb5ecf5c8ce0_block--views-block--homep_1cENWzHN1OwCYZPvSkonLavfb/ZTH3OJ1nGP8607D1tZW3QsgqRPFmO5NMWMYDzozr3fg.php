...
/* themes/custom/ana_zymphonies/templates/block/block--views-block--homepage-block-3-2.html.twig */
class __TwigTemplate_0827c0e6a7428c85233b09caf4a0e3ed5a4b3c1199a64fe3097fa92aa7aac8a6 extends \Twig\Template
{
...
";
  ...
  ";
    ...
    {
        return "themes/custom/ana_zymphonies/templates/block/block--views-block--homepage-block-3-2.html.twig";
    }
...
%}
<div class=\"most-viewed {{ attributes.class }}\"{{attributes|without('class') }}>
  {{ title_prefix }}
  {% if label %}
    <h2  class=\"most-viewed {{ title_attributes.class }}\" {{title_attributes|without('class') }}>{{ label }}</h2>
  {% endif %}
  {{ title_suffix }}
  {% block content %}
    {{ content }}
...
", "themes/custom/ana_zymphonies/templates/block/block--views-block--homepage-block-3-2.html.twig", "C:\\xampp\\htdocs\\newslive\\themes\\custom\\ana_zymphonies\\templates\\block\\block--views-block--homepage-block-3-2.html.twig");
    }
}
