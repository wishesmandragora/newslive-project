...
/* themes/custom/ana_zymphonies/templates/block/block--views-block--categories-block-1-3.html.twig */
class __TwigTemplate_f998f0e4fcdf9845f99baacfe9d4739ad9b87917df678514f075123f180086f4 extends \Twig\Template
{
...
";
  ...
  ";
    ...
    {
        return "themes/custom/ana_zymphonies/templates/block/block--views-block--categories-block-1-3.html.twig";
    }
...
%}
<div class=\"hot-categories {{ attributes.class }}\"{{attributes|without('class') }}>
  {{ title_prefix }}
  {% if label %}
    <h2  class=\"hot-categories {{ title_attributes.class }}\" {{title_attributes|without('class') }}>{{ label }}</h2>
  {% endif %}
  {{ title_suffix }}
  {% block content %}
    {{ content }}
...
", "themes/custom/ana_zymphonies/templates/block/block--views-block--categories-block-1-3.html.twig", "C:\\xampp\\htdocs\\newslive\\themes\\custom\\ana_zymphonies\\templates\\block\\block--views-block--categories-block-1-3.html.twig");
    }
}
