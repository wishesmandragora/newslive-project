...
/* themes/custom/ana_zymphonies/templates/block/block--views-block--homepage-block-5-3.html.twig */
class __TwigTemplate_55e2b1f35c06ed0f4b7b56aa45a6147538fece9d2426961397d4df409e26a5b9 extends \Twig\Template
{
...
";
  ...
  ";
    ...
    {
        return "themes/custom/ana_zymphonies/templates/block/block--views-block--homepage-block-5-3.html.twig";
    }
...
%}
<div class=\"trending-now {{ attributes.class }}\"{{attributes|without('class') }}>
  {{ title_prefix }}
  {% if label %}
    <h2  class=\"trending-now {{ title_attributes.class }}\" {{title_attributes|without('class') }}>{{ label }}</h2>
  {% endif %}
  {{ title_suffix }}
  {% block content %}
    {{ content }}
...
", "themes/custom/ana_zymphonies/templates/block/block--views-block--homepage-block-5-3.html.twig", "C:\\xampp\\htdocs\\newslive\\themes\\custom\\ana_zymphonies\\templates\\block\\block--views-block--homepage-block-5-3.html.twig");
    }
}
